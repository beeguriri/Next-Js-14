...
export default function NavMenu() {
  ...
  //next에서 제공하는 hook
  //내가 어느 메뉴에 있는지에 대한 값이 들어옴
  //만약에 내가 compose/tweet에 있다면
  //segment의 값은 compose
  //compose/tweet까지 받고싶다면 useSelectedLayoutSegments를 씀
  ...
  return (
    <>
      ...
      <li>
        <Link href="/explore">
          <div className={style.navPill}>
            {segments[0] && (['search', 'explore'].includes(segments[0])) ?
              <>
                <svg width={26} viewBox="0 0 24 24" aria-hidden="true"
                  className="r-18jsvk2 r-4qtqp9 r-yyyyoo r-lwhw9o r-dnmrzs r-bnwqim r-1plcrui r-lrvibr r-cnnz9e">
                  <g>
          ...
          <div className={style.navPill}>
            {segments[0] === 'bookmarks' ?
              <>
                ...
                <div style={{ fontWeight: 'bold' }}>북마크</div>
              </> :
              <>
                <svg width={26} viewBox="0 0 24 24" aria-hidden="true" 
                  className="r-4qtqp9 r-yyyyoo r-dnmrzs r-bnwqim r-1plcrui r-lrvibr r-18jsvk2 r-lwhw9o r-cnnz9e">
          ...
          <div className={style.navPill}>
            {segments[0] === me.id  && segments[1] === 'communities' ? 
              <>
                ...
                <div style={{ fontWeight: 'bold' }}>커뮤니티</div>
              </> :
              <>
                <svg width={26} viewBox="0 0 24 24" aria-hidden="true" 
                  className="r-4qtqp9 r-yyyyoo r-dnmrzs r-bnwqim r-1plcrui r-lrvibr r-18jsvk2 r-lwhw9o r-cnnz9e">
