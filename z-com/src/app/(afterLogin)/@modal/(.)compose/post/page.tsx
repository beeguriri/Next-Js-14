    ...
    <div className={style.modalBackground}>
      <div className={style.modal}>
        ...
        <button className={style.closeButton} onClick={onClickClose}>
          <svg width={24} viewBox="0 0 24 24" aria-hidden="true"><g><path d="M10.59 12L4.54 5.96l1.42-1.42L12 10.59l6.04-6.05 1.42 1.42L13.41 12l6.05 6.04-1.42 1.42L12 13.41l-6.04 6.05-1.42-1.42L10.59 12z"></path></g></svg>
        </button>
        {/* text area */}
        <form className={style.modalForm} onSubmit={onSubmit}>
          ...
          <div className={style.modalFooter}>
            ...
            <div className={style.footerButtons}>
              {/* ⬇️ TODO : 관련 버튼들 나열하기 << home 화면의 post 참조 => 왼쪽으로 몰아 정렬 */}
